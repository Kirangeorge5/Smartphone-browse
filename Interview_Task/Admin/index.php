            ...
            <div class="container-fluid">
              <div class="row">
               ...
               <a class="navbar-brand"><img src="../images/logo.jpg" alt="" class="logo">Tech Haven</a>
                ...
                <a class="navbar-brand" href="#"><i class="fa-solid fa-right-to-bracket"></i>Login</a>
          ...
          <div class="row">
            <div class="col-md-12 bg-danger p-1">
                <div class="button text-center">
                    ...
                    <button><a href="index.php?insert_model" class="nav-link text-dark  my-1">Insert Models</a></button>
                    <button><a href="index.php?insert_brand" class="nav-link text-dark  my-1">Insert Brands</a></button>
